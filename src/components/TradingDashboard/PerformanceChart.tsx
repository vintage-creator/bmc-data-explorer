...
export const PerformanceChart = () => {
  ...
  return (
    ...
    >
      {/* Make sure Card can use full width */}
      <Card className="p-6 bg-card border-border w-full">
        ...
        {/* Crucial: parent div with explicit height and full width */}
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis
                ...
                style={{ fontSize: 12 }}
                interval={0}                    // show all ticks (okay for small set)
                tick={{ dy: 6 }}                // slight vertical padding for readability
                tickFormatter={(t) => t}        // optionally shorten labels here
              />
              <YAxis
                stroke="hsl(var(--muted-foreground))"
                style={{ fontSize: 12 }}
              ...
              <Area
                ...
                isAnimationActive={false} // optional: disable animation for small screens
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
